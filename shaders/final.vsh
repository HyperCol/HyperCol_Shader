...
void main() {
    ...
    avgSkyBrightness = dot(calculateAtmosphere(vec3(0.0), vec3(0.0, 1.0, 0.0), vec3(0.0, 1.0, 0.0), wSunVector, wMoonVector, planetSphere, transmittance, 10), vec3(0.0, 0.0, 1.0));
